    ...
    <div className="mx-auto w-full max-w-5xl px-5 py-6 md:px-12 md:py-11">
      ...
      <section aria-labelledby="notification-preferences" className="grid gap-6">
        ...
        <div className="border-t pt-5">
          ...
          {(support === "unsupported" || support === "blocked") && /iPhone|iPad/.test(navigator.userAgent) && <p className="mt-3 text-sm text-muted-foreground">No iPhone ou iPad, instale o K5 na Tela de Início pelo Safari e ative os avisos dentro do aplicativo instalado.</p>}
        </div>
