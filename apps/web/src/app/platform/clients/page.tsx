...
export const metadata = { title: "Clientes da plataforma" };
        ...
        <table className="w-full text-left">
          ...
          <tbody>{offices.map((office) => (
            <tr key={office.id} className="border-b last:border-0">
              ...
              <td className="py-4 pl-4 text-right"><Link href={`/platform/clients/${office.id}/ai`} className="inline-flex min-h-11 items-center whitespace-nowrap rounded-md px-2 font-medium hover:bg-muted focus-visible:outline-none focus-visible:ring-2 md:min-h-8">Gerenciar IA</Link></td>
            </tr>
          ))}</tbody>
        </table>
