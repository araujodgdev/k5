...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="app-shell flex min-h-dvh flex-col bg-background md:flex-row md:bg-canvas">
      ...
      <main id="main-content" className="flex min-h-0 min-w-0 flex-1 flex-col bg-background pb-dock md:my-2 md:mr-2 md:h-[calc(100dvh-1rem)] md:rounded-2xl md:border md:pb-0">
